...
public class Tabuleiro {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            t.exibirTabuleiro();
            System.out.println("Turno: " + (t.whiteToMove ? "Branco" : "Preto"));
            ...
            if (ok) {
                ...
                // após aplicar, verificar cheque-mate / empate por afogamento (stalemate)
                ...
                if (!opponentHasMove) {
                    // mostra tabuleiro final antes de anunciar
                    t.exibirTabuleiro();
                    if (opponentInCheck) {
                        // quem moveu agora (anterior) venceu
                    ...
                    // mostrar se o oponente está em cheque
                    if (opponentInCheck) {
